...
<h1>Contáctenos</h1>
            <table border="0">
				<tr>
					...
					<td width="32%">
                        <input name="ctl00$ContentPlaceHolder1$TxtNombre" type="text" id="ctl00_ContentPlaceHolder1_TxtNombre" tabindex="1" style="width:220px;" /><br />
                        <span id="ctl00_ContentPlaceHolder1_RequiredFieldValidator1" style="color:Red;font-size:0.67em;font-style:italic;text-decoration:none;display:none;">*Dato requerido</span>
                        <span id="ctl00_ContentPlaceHolder1_RegularExpressionValidator1" style="color:Red;font-size:0.67em;display:none;">*Digite solo letras</span>
                    </td>
		...
		<option value="4">Referencia de un Tercero</option>
			    ...
			    <tr>
			        ...
			        <td colspan="3">
                        <textarea name="ctl00$ContentPlaceHolder1$TxtConsulta" rows="5" cols="60" id="ctl00_ContentPlaceHolder1_TxtConsulta" tabindex="13" onkeyup="textCounter(this, this.form.remLen, 300);" onkeydown="textCounter(this, this.form.remLen, 300);" style="height:60px;width:350px;"></textarea>
			    ...
			    <tr>
			        ...
			        <td height="60" colspan="4" style="text-align:right">
                        <input type="submit" name="ctl00$ContentPlaceHolder1$btnEnviar" value="Enviar" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ctl00$ContentPlaceHolder1$btnEnviar&quot;, &quot;&quot;, true, &quot;&quot;, &quot;&quot;, false, false))" id="ctl00_ContentPlaceHolder1_btnEnviar" />
                    </td>
			    </tr>
			</table>        
